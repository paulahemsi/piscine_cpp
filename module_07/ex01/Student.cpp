...
/*   Updated: 2021/11/02 16:52:50 by phemsi-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		Student::setLevel(float level)
{
	this->_level = level;
	return ;
}
...
float Student::operator+=(int right_hand_side)
{
	return (this->_level += right_hand_side);
}
